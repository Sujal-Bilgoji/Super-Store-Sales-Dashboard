...
The dataset represents a Super Store sales dataset containing:

a) Order Details (Order ID, Order Date, Ship Mode)

b) Customer Details (Customer Name, Segment, Region, State, City)

c) Product Information (Category, Sub-Category, Product Name)
...
a) Sales by Category and Sub-Category

b) Regional Sales Performance (Map View)

c) Monthly and Yearly Sales Trends

d) Customer Segment Performance
...
a) Trend-based monthly sales prediction

b) Confidence interval for forecast reliability
